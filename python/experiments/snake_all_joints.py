...
path_to_output_snake = os.path.join(path_to_output, "robot_snake/")
...
from python.step_backward_edge import multiple_steps_backward_material_pos_
from python.step_forward_edge import multiple_steps_forward
