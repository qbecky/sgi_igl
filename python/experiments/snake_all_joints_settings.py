...
def return_snake_all_joints_experiment_settings(trial_number):
    '''
    Args:
    ...
    target_translation = np.array([1.0 * settings_dict['snake_length'], 0.0, 0.0])
